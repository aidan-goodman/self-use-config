...
_G.packer_plugins = {
  ...
  ["nvim-ts-rainbow"] = {
    loaded = true,
    path = "/home/aidan/.local/share/nvim/site/pack/packer/start/nvim-ts-rainbow",
  ...
  ["telescope-ui-select.nvim"] = {
    loaded = true,
    path = "/home/aidan/.local/share/nvim/site/pack/packer/start/telescope-ui-select.nvim",
